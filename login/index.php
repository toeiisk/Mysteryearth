  ...
  <div class="wrapper text-center justify-content-center ">
    <div class="form-signin rounded">
      <form method="post" form="Login">
        ...
        <input type="password" class="form-control" name="password" placeholder="Password" style="margin-bottom: 30px !important;" required=""/>
        <?php
        if ($status_error == 1) { ?>
          <sp class="">
      ...
      <button class="btn btn-lg btn-primary btn-block eng mb-2" name="form" value="Login" type="submit">Login</button>
      <a href="../register/"><button class="btn btn-lg btn-primary btn-block eng mb-2">Register</button></a>
